...
import com.TicketXChange.TicketXChange.auth.controller.OTPController;
import com.TicketXChange.TicketXChange.auth.dtos.AuthenticationRequest;
...
import com.TicketXChange.TicketXChange.auth.enums.TokenType;
import com.TicketXChange.TicketXChange.auth.exception.InvalidCredentialsException;
import com.TicketXChange.TicketXChange.auth.exception.UserNotFoundException;
import com.TicketXChange.TicketXChange.auth.model.Token;
import com.TicketXChange.TicketXChange.auth.model.User;
import com.TicketXChange.TicketXChange.auth.model.UserProfile;
import com.TicketXChange.TicketXChange.auth.repository.TokenRepository;
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        try {
            ...
            if(!validatePassword(request.getPassword())){
                throw new IllegalArgumentException("Password should contain at least 8 characters, including at least one uppercase letter, one lowercase letter, one number, and one special character");
            }
